...
//What this script is for is to interpret commands written in dialogue files. Necessary to code various things related to the game such as entering cross exam using text files
public class DL_COMMAND_DATA
{
    ...
    public DL_COMMAND_DATA(string rawCommand)
    {
